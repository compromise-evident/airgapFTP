...
See [LED.cpp](https://github.com/compromise-evident/airgapFTP/blob/main/Other/LED/LED.cpp). (Might need to tilt photoresistor away from LED as above. Use it in a dark enclosure.) <br>
